...
public class Order {
    public enum OrderStatus { CREATED, PENDING_PAYMENT, PAID, SHIPPED, DELIVERED, FAILED, CANCELLED }
    ...
    public void setFinalAmount(double finalAmt) { this.finalAmount = finalAmt; }
